...
'info_gauche_auteurs_exterieurs' => 'Lu autors exteriors, sensa accès au sit, son indicats per una icòna blava; lu autors esfaçats per un bordilhier.',
...
'info_image_process2' => '<b>N.B.</b> <i>Se minga d\'imatge apareisse, alora lo servidor qu\'aubèrga lo vòstre sit non l\'an configurat per utilizar d\'aisinas tali. Se desiratz d\'utilizar aqueli foncions, contactatz lo responsable tecnic e demandatz li extensions «GD» ò «Imagick».</i>',
...
'taille_cache_octets' => 'Aüra la talha de l\'escondedor compassa @octets@.',
...
'texte_informations_personnelles_2' => '(Nòta: se s\'agisse d\'una reïnstallacion, e se lo vòstre accès fonciona encara, podètz',
