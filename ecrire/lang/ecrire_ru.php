...
'avis_base_inaccessible' => 'Impossible to connect to the database @base@.', # NEW
...
'bouton_fermer' => 'Close', # NEW
'bouton_mettre_a_jour_base' => 'Update the database', # NEW
...
'creer_et_associer_un_auteur' => 'Create and associate an author', # NEW

// D
'date_mot_heures' => ':',

// E
'ecran_securite' => '+ safety screen @version@', # NEW
...
'erreur_connect_deja_existant' => 'There is already a server with that name ', # NEW
'erreur_nom_connect_incorrect' => 'Server name not allowed', # NEW
...
'impossible_modifier_login_auteur' => 'Login cannot be changed.', # NEW
'impossible_modifier_pass_auteur' => 'Password cannot be changed.', # NEW
...
'info_admin_gere_toutes_rubriques' => 'Этот администратор управляет<b> всеми разделами</b>.', # MODIF
'info_admin_gere_toutes_rubriques_2' => 'Je gère <b>toutes les rubriques</b>', # NEW
'info_admin_je_suis_webmestre' => 'I am a <b>webmaster</b>', # NEW
...
'info_articles_miens' => 'My articles', # NEW
'info_articles_tous' => 'All the articles', # NEW
...
'info_aucun_article' => 'No articles', # NEW
'info_aucun_article_syndique' => 'No syndicated articles', # NEW
'info_aucun_auteur' => 'No authors', # NEW
'info_aucun_message' => 'No messages', # NEW
'info_aucun_rubrique' => 'No sections', # NEW
'info_aucun_site' => 'No linked sites', # NEW
'info_aucun_visiteur' => 'No visitors', # NEW
...
'info_compatibilite_html' => 'HTML norm to apply', # NEW
...
'info_creation_paragraphe' => '(Для создания параграфов, Вы просто оставляете строки пустыми)', # MODIF
...
'info_gerer_trad_objets' => '@objets@: manage translation links', # NEW
...
'info_login_trop_court_car_pluriel' => 'Your login must contain at least @nb@ characters.', # MODIF
'info_logos' => 'Логотипы',
...
'info_mise_a_niveau_base_2' => '{{Предупреждение!}} Вы установили версию 
 ...
 SPIP Файлы.}}',
'info_modification_enregistree' => 'Your changes have been saved', # NEW
...
'info_multi_objets' => '@objets@: activate the language menu', # NEW
...
'info_obligatoire_02' => '[Необходимая]', # MODIF
...
'info_passe_trop_court_car_pluriel' => 'Your password must contain at least @nb@ characters.', # MODIF
...
'info_qui_edite' => '@nom_auteur_modif@ worked on the contents @date_diff@ minutes ago', # NEW
...
'info_texte_message' => 'Текст Вашего сообщения:', # MODIF
...
'info_traductions' => 'Translations', # NEW
...
'install_connect_ok' => 'The new database has been declared using the server name @connect@.', # NEW
...
// L
'label_bando_outils' => 'Toolbar', # NEW
'label_bando_outils_afficher' => 'Show the tools', # NEW
'label_bando_outils_masquer' => 'Hide the tools', # NEW
'label_choix_langue' => 'Choose your language', # NEW
'label_nom_fichier_connect' => 'Indicate the name for this server', # NEW
...
'ldap_correspondance_2' => 'For each of these SPIP fields, enter the name of the corresponding LDAP field. Leave blank if you don\'t want it filled, separate with spaces or commas to try several LDAP fields.', # NEW
...
'lien_retirer_tous_auteurs' => 'Remove all authors', # NEW
...
'logo_article' => 'ЛОГОТИП СТАТЬИ', # MODIF
'logo_auteur' => 'ЛОГОТИП АВТОРА', # MODIF
'logo_rubrique' => 'ЛОГОТИП РАЗДЕЛА', # MODIF
...
'plugin_info_erreur_xml' => 'Incorrect declaration of the plugin', # NEW
...
'plugin_info_install_ok' => 'Installation successful', # NEW
'plugin_info_necessite' => 'Required:', # NEW
'plugin_info_non_compatible_spip' => 'This plugin is incompatible with this version of SPIP', # NEW
...
// Q
'queue_executer_maintenant' => 'Run now', # NEW
'queue_nb_jobs_in_queue' => '@nb@ tasks in queue', # NEW
'queue_next_job_in_nb_sec' => 'Next job in @nb@ s', # NEW
'queue_no_job_in_queue' => 'No pending tasks', # NEW
'queue_one_job_in_queue' => '1 job in queue', # NEW
'queue_purger_queue' => 'Purge job queue', # NEW
'queue_titre' => 'List of tasks', # NEW
...
'texte_compatibilite_html' => 'You can require SPIP to produce code compatible with the <i>HTML4</i> standard, or allow it to use more modern <i>HTML5</i> compatible code.', # NEW
...
'texte_en_cours_validation' => 'Эти статьи и новости отправлены на утверждение. ', # MODIF
...
'titre_ajouter_un_auteur' => 'Add an author', # NEW
'titre_ajouter_un_mot' => 'Add a keyword', # NEW
...
'titre_cadre_numero_objet' => '@objet@ NUMBER:', # NEW
...
'titre_langue_rubrique' => 'ЯЗЫКОВОЙ РАЗДЕЛ', # MODIF
