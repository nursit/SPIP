...
обратитесь к . <a href="@spipnet@">документации SPIP </a>.',
  ...
  в целях безопасности (лучше иметь большее количество хостов).',
	...
	'bouton_envoyer_message' => 'Последнее сообщение: отправить', # MODIF
	...
	'config_info_enregistree' => 'Новые настройки были сохранены',
...
Переводы связанные с оригиналом, 
 в цвете указывающем на их статус:в цвете, указывающем их статус:',
	...
	'install_types_db_connus' => 'SPIP может использовать <b>MySQL</b>,  <b>PostgreSQL</b> и <b>SQLite</b>.', # MODIF
	'install_types_db_connus_avertissement' => 'N.B.: некоторые плагины работают только с MySQL', # MODIF
	...
	'plugin_info_extension_1' => 'Эти компоненты установлены в папку @extensions@ и активированы.', # MODIF
	'plugin_info_extension_2' => 'Не могут быть удалены.', # MODIF
	...
	'plugins_liste_extensions' => 'Компоненты', # MODIF
