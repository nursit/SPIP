...
'info_compresseur_gzip' => 'Для начала рекомендуется проверить сжимает ли поставщик услуг PHP скрипты систематически. Для этого Вы можете, например, использовать следующую услугу: @testgzip@', # MODIF
...
'info_email_webmestre' => 'Адрес электронной почты веб-мастера(дополнительно)', # MODIF
...
'info_image_process2' => '<b>N.B.</b> <i>, Если Вы не можете видеть  изображения, значит Ваш сервер не настроен для их использования. Если Вы хотите использовать данные функции, свяжитесь с технической поддержкой Вашего провайдера и спросите о «GD» или расширения «Imagick», которые будут установлены. </i>', # MODIF
