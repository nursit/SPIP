...
Статус автора обозначен цветом (администратор = зеленый; автор = желтый).',
	'info_gauche_auteurs_exterieurs' => 'Посетители без доступа в систему управления, обозначены синим цвета; удаленные автора - иконкой корзины.', # MODIF
...
<p>Если у вас нет необходимости в таких действиях, то оставьте это значение по умолчанию.</p>',
	...
	'texte_informations_personnelles_2' => '(Примечание: если это - переустановка, и Ваш доступ все еще работает, Вы можете', # MODIF
 ...
 если Вы желаете выполнить быструю переиндексацию (после восстановления 
  ...
  индексированы снова: поэтому эта команда полезна только в особых случаях.',
	...
	'texte_multilinguisme' => 'Если на сайте публикуются статьи на нескольких языках Вы можете добавить меню выбора языков к статьям и/или к разделам.', # MODIF
	'texte_multilinguisme_trad' => 'Кроме того, Вы можете включить ссылку системы управления между разными переводами статьи.', # MODIF
