...
'erreur_plugin_fichier_absent' => 'Fichièr absent', # NEW
'erreur_plugin_fichier_def_absent' => 'Fichièr de definicion absent', # NEW
...
'erreur_plugin_tag_plugin_absent' => '&lt;ajuston&gt; mancant dins lo fichièr de definicion', # NEW
...
'info_syndication_integrale_1' => 'Vòstre sit prepausa de fichièrs de sindicacion (véser « <a href="@url@">@titre@</a> »).', # NEW
'info_syndication_integrale_2' => 'Desiratz transmetre l\'integralitat dels articles, o ne difusar pas qu\'un resumit de qualques centenas de caractèrs ?', # NEW
...
'item_autoriser_syndication_integrale' => 'Difusar l\'integralitat dels articles dins los fichièrs de sindicacion', # NEW
...
'texte_jeu_caractere_4' => 'En cas qu\'aquò corresponda pas a la realitat de vòstras donadas), o <em>que comencetz a pro pena aquel sit</em> e desiretz causir un autre jòc de caractèrs, indicatz-lo aicí : ', # NEW
'texte_jeu_caractere_conversion' => 'Nòta : podètz decidir de convertir un còp per totes l\'ensem dels tèxtes de vòstre sit (articles, brèvas, forums, etc.) cap a l\'alfabet <tt>utf-8</tt>, en anar a <a href="@url@">la pagina de conversion vèrs l\'utf-8</a>.', # NEW
...
'texte_multilinguisme' => 'Se desiratz de gerir d\'articles en mai d\'una lenga, amb una navigacion complèxa, podètz apondre un menut per chausir la lenga deis articles e/o dei rubricas, en foncion de l\'organizacion de vòstre sit.',
'texte_multilinguisme_trad' => 'Podètz tanben activar un sistèma de gestion dei liames entre lei diferentei reviradas d\'un article.',
...
'texte_presente_plugin' => 'Aquela pagina lista los ajustons disponibles sus lo sit. Podètz activar los ajustons necessaris en marcar la casa correspondenta.', # NEW
...
'utf8_convert_avertissement' => 'Sètz a mand de convertir lo  contengut de vòstra basa de donadas (articles, brèvas, etc) del jòc de caractèrs <b>@orig@</b> cap al jòc de caractèrs <b>@charset@</b>.', # NEW
'utf8_convert_backup' => 'Doblidètz pas de far d\'en primièr un salvament complet de vòstre sit. Vos cal tanben verificar que vòstras esqueletas e fichièrs de lenga son compatibles @charset@. De mai, lo seguit de las revisions, s\'es activat, serà degalhat.', # NEW
'utf8_convert_erreur_deja' => 'Vòtre sit es ja en @charset@, inutil de lo convertir...', # NEW
'utf8_convert_erreur_orig' => 'Error : lo jòc de caractèrs @charset@ es pas suportat.', # NEW
'utf8_convert_termine' => 'Es acabat !',
'utf8_convert_timeout' => '<b>Important :</b> en cas de <i>timeout</i> del servidor, volgatz recargar la pagina fins a çò qu\'indique « acabat ».', # NEW
'utf8_convert_verifier' => 'Vos cal ara vojar l\'escondedor, e verificar que tot va plansus las paginas publicas del sit. En cas de gròs problèma, un salvament de vòstras donadas s\'es realizat (de format SQL) dins lo repertòri @rep@.', # NEW
