...
',
	...
	'form_forum_confirmer_email' => 'Для подтверждения email перейдите по ссылке: @url_confirm@',
...
"@nom_site_spip@" (@adresse_login@):',
	...
	'icone_creer_rubrique' => 'Создать раздел',
	'icone_creer_sous_rubrique' => 'Создать подраздел',
	'icone_deconnecter' => 'Выход',
 ...
 или обратитесь к вашему хостинг-провайдеру.</font>',
	...
	'info_multi_langues_soulignees' => '<u>подчеркнутый язык</u> обозначает, что административная часть сайта полностью переведена на этот язык. При выборе прочих языков для перевода интерфейса будет использован основной язык сайта.', # MODIF
	'info_multilinguisme' => 'Настройки многоязычности',
...
-----------------',
	...
	'info_travaux_texte' => 'Сайт еще не настроен. Посетите нас позже.',
	'info_travaux_titre' => 'Сайт в разработке',
