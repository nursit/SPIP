...
'install_types_db_connus_avertissement' => 'Warning: some plugins only function with MySQL',
...
to refresh a single page, it is easier to view that page from the public site and click "Recalculate this page".',
