...
'avis_erreur_version_archive' => '<b>Attention! Le fichier @archive@ correspond à
    ...
    d\'informations, voyez <a href="@spipnet@">
                                la documentation de SPIP</a>.</p>', # NEW
...
'avis_lecture_noms_bases_2' => 'Soit aucune base n\'est disponible, soit la fonction permettant de lister les bases a été désactivée
		pour des raisons de sécurité (ce qui est le cas chez de nombreux hébergeurs).', # NEW
...
'calendrier_synchro' => 'Si vous utilisez un logiciel d\'agenda compatible <b>iCal</b>, vous pouvez le synchroniser avec les informations de ce site.', # NEW
...
'entree_login_connexion_2' => '(Correspond parfois à votre login d\'accès au FTP; parfois laissé vide)', # NEW
...
'info_administrateur_site_01' => 'Si vous êtes administrateur du site, veuillez', # NEW
...
'info_ajout_image' => 'Lorsque vous ajoutez des images en tant que documents joints à un article,
		...
		automatiquement une galerie ou un portfolio.', # NEW
...
'info_chemin_acces_2' => 'Vous devez désormais configurer le chemin d\'accès aux informations dans l\'annuaire. Cette information est indispensable pour lire les profils utilisateurs stockés dans l\'annuaire.', # NEW
...
exige d\'avoir un accès FTP au site Web.</p>', # NEW
...
'info_gauche_auteurs_exterieurs' => 'Anqajankir qillqirinakax, qamawir jan mantañaniwa, mä laram jisk\'a saltampiw uñacht\'ayataski; mä wayaqamp chhaqayatakis.',
...
'info_jeu_caractere' => 'Jeu de caractères du site', # NEW
'info_jours' => 'jours', # NEW
'info_laisser_champs_vides' => 'laisser ces champs vides)', # NEW
...
'info_message' => 'Message du', # NEW
'info_message_efface' => 'MESSAGE EFFACÉ', # NEW
'info_message_en_redaction' => 'Vos messages en cours de rédaction', # NEW
'info_message_technique' => 'Message technique :', # NEW
'info_messagerie_interne' => 'Messagerie interne', # NEW
'info_mise_a_niveau_base' => 'mise à niveau de votre base SQL', # NEW
...
'info_multi_langues_choisies' => 'Veuillez sélectionner ci-après les langues à disposition des rédacteurs de votre site.
		Les langues déjà utilisées dans votre site (affichées en premier) ne peuvent pas être désactivées.', # NEW
...
'info_multi_secteurs' => '... seulement pour les rubriques situées à la racine ?', # NEW
...
'info_nombre_sites' => '@nb_sites@ sites,', # NEW
'info_non_deplacer' => 'Ne pas déplacer...', # NEW
'info_non_envoi_annonce_dernieres_nouveautes' => 'SPIP peut envoyer, régulièrement, l\'annonce des dernières nouveautés du site
		(articles et brèves récemment publiés).', # NEW
'info_non_envoi_liste_nouveautes' => 'Ne pas envoyer  la liste des nouveautés', # NEW
'info_non_modifiable' => 'ne peut pas être modifié', # NEW
'info_non_suppression_mot_cle' => 'je ne veux pas supprimer ce mot-clé.', # NEW
'info_note_numero' => 'Note @numero@', # NEW
'info_notes' => 'Notes', # NEW
'info_nouveaux_message' => 'Nouveaux messages', # NEW
'info_nouvel_article' => 'Nouvel article', # NEW
'info_nouvelle_traduction' => 'Nouvelle traduction :', # NEW
...
'info_pour' => 'pour', # NEW
'info_preview_admin' => 'Seuls les administrateurs peuvent prévisualiser le site', # NEW
...
'info_procedure_maj_version' => 'la procédure de mise à jour doit être lancée afin d\'adapter
	la base de données à la nouvelle version de SPIP.', # NEW
...
'info_recherche_auteur_ok' => 'Plusieurs rédacteurs trouvés pour "@cherche_auteur@":', # NEW
'info_recherche_auteur_zero' => 'Aucun résultat pour « @cherche_auteur@ ».', # NEW
'info_recommencer' => 'Veuillez recommencer.', # NEW
'info_redacteur_1' => 'Rédacteur', # NEW
'info_redacteur_2' => 'ayant accès à l\'espace privé (<i>recommandé</i>)', # NEW
...
'info_statut_administrateur' => 'Administrateur', # NEW
'info_statut_auteur' => 'Statut de cet auteur :', # NEW
...
'info_taille_maximale_vignette' => 'Taille maximale des vignettes générées par le système :', # NEW
'info_terminer_installation' => 'Vous pouvez maintenant terminer la procédure d\'installation standard.', # NEW
...
'info_tous_les' => 'tous les :', # NEW
'info_tous_redacteurs' => 'Annonces à tous les rédacteurs', # NEW
'info_tout_site' => 'Tout le site', # NEW
'info_tout_site2' => 'L\'article n\'a pas été traduit dans cette langue.', # NEW
'info_tout_site3' => 'L\'article a été traduit dans cette langue, mais des modifications ont été apportées par la suite à l\'article de référence. La traduction doit être mise à jour.', # NEW
'info_tout_site4' => 'L\'article a été traduit dans cette langue, et la traduction est à jour.', # NEW
'info_tout_site5' => 'Article original.', # NEW
'info_tout_site6' => '<b>Attention :</b> seuls les articles originaux sont affichés.
Les traductions sont associées à l\'original,
dans une couleur qui indique leur état :', # NEW
...
'install_select_langue' => 'Sélectionnez une langue puis cliquez sur le bouton « suivant » pour lancer la procédure d\'installation.', # NEW
...
'lien_tout_deplier' => 'Tout déplier', # NEW
...
'module_raccourci' => 'Raccourci', # NEW
'module_texte_affiche' => 'Texte affiché', # NEW
...
'module_texte_traduction' => 'Le fichier de langue « @module@ » est disponible en :', # NEW
...
'texte_article_virtuel_reference' => '<b>Article virtuel :</b> article référencé dans votre site SPIP, mais redirigé vers une autre URL. Pour supprimer la redirection, effacez l\'URL ci-dessus.', # NEW
'texte_aucun_resultat_auteur' => 'Aucun résultat pour "@cherche_auteur@"', # NEW
...
'texte_date_creation_article' => 'DATE DE CRÉATION DE L\'ARTICLE :', # on ajoute le ":" NEW
...
'texte_en_cours_validation' => 'Les contenus ci-dessous sont en attente de validation.', # NEW
...
'texte_plus_trois_car' => 'plus de 3 caractères', # NEW
'texte_plusieurs_articles' => 'Plusieurs auteurs trouvés pour "@cherche_auteur@":', # NEW
...
recalculer une seule page, passez plutôt par l\'espace public et utilisez-y le bouton « recalculer ».', # NEW
...
'texte_statut_publies' => 'publiés en ligne', # NEW
'texte_statut_refuses' => 'refusés', # NEW
...
'texte_tenter_reparation' => 'Tenter une réparation de la base de données', # NEW
'texte_test_proxy' => 'Pour faire un essai de ce proxy, indiquez ici l\'adresse d\'un site Web
				que vous souhaitez tester.', # NEW
'texte_titre_02' => 'Titre :', # NEW
'texte_titre_obligatoire' => '<b>Titre</b> [Obligatoire]', # NEW
'texte_travail_article' => '@nom_auteur_modif@ a travaillé sur cet article il y a @date_diff@ minutes', # NEW
...
'texte_utilisation_moteur_syndiques' => 'Lorsque vous utilisez le moteur de recherche intégré
    ...
    recherche dans le texte du site lui-même.', # NEW
...
'trad_delier' => 'Ne plus lier à ces traductions', # NEW
'trad_lier' => 'Cet article est une traduction de l\'article numéro :', # NEW
'trad_new' => 'Écrire une nouvelle traduction', # NEW
