...
يا شبكه به شما داده شود',
 ...
 (غير فعال كردن آن سرعت سيستم را افزايش ميدهد)',
	...
	'install_types_db_connus' => 'اسپيپ مي‌تواند<b>MySQL</b> (رايج‌تر)، <b>PostgreSQL</b> و <b>SQLite</b> را استفاده كند.', # MODIF
	'install_types_db_connus_avertissement' => 'توجه: بعضي از پلاگين‌ها فقط با ماي‌اسكيوال كار مي‌كنند', # MODIF
	...
	'plugin_info_extension_1' => 'توسعه‌ها(اكستنشن‌)ي زير در ديركتوري @extensions@ بارگذار و فعال مي‌شوند.', # MODIF
	'plugin_info_extension_2' => 'آن‌ها نصب‌ زدايي نمي‌شوند.', # MODIF
	...
	'plugins_liste_extensions' => 'توسعه‌ها', # MODIF
