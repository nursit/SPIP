...
يا شبكه به شما داده شود',
	...
	'info_compresseur_gzip' => 'توصيه مي‌شود ابتدا ببينيد كه ارايه دهنده خدمات نويسه‌هاي پي.اچ.پي را به صورت سيستماتيك فشرده مي‌كند يا نه. براي اين كار مي‌توايد به عنوان نمونه از خدمات  : @testgzip@ استفاده كنيد.', # MODIF
	...
	'info_email_webmestre' => 'آدرس ايميل وب مستر (انتخابى )', # MODIF
	...
	'info_image_process2' => '<<b>N.B.</b> درصورتيكه تصويرى ظاهر نشود, سرورى كه سايتتان را پذيراست براى چنين ابزارى پيكربندى نشده است. اگر مايل به استفاده از اين كاركردها هستيد با سرپرست فنى تماس بگيريد و تقاضاىGD          يا   «Imagick» را بكنيد.', # MODIF
