...
stránku "@nom_site_spip@" (@adresse_login@):',
	...
	'icone_suivi_pettions' => 'Riadiť petície',
 ...
 alebo kontaktujte poskytovateľa služby.</font>',
	...
	'info_multi_langues_soulignees' => '<u>Podčiarknuté jazyky</u> poskytujú preklad všetkých textov rozhrania. Ak si vyberiete tieto jazyky, mnohé prvky verejne prístupnej stránky (dátumy, formuláre) sa preložia automaticky. Ak si vyberiete niektorý z jazykov, ktoré nie sú podčiarknuté, tieto prvky zobrazia v hlavnom jazyku stránky.',
...
------------------',
   ...
   v prehliadači a',
	...
	'login_sans_cookiie' => 'Identifikácia bez cookie',
...
',
 ...
 nechať tieto zmeny na hlavného webmastera stránky.</b>',
	...
	// Z
	'zbug_balise_b_aval' => ': tag B je v slučke príliš neskoro',
	'zbug_balise_inexistante' => 'Tag @balise@ je zle deklarovaný pre @from@',
	'zbug_balise_sans_argument' => 'V tagu @balise@ chýba parameter',
	'zbug_boucle' => 'slučka',
	'zbug_boucle_recursive_undef' => 'nedefinovaná rekurzívna slučka: @nom@',
	'zbug_calcul' => 'Výpočet',
	'zbug_champ_hors_boucle' => 'Pole @champ@ mimo slučky',
	...
	'zbug_erreur_boucle_double' => 'SLUČKA @id@: dvojitá definícia',
	'zbug_erreur_boucle_fermant' => 'SLUČKA @id@: chýba uzatvárací tag',
	'zbug_erreur_boucle_syntaxe' => 'Nesprávna syntax (BOUCLE)',
	...
	'zbug_erreur_meme_parent' => '{meme_parent} platí len pre slučky (DISKUSNÉ FÓRA) a (RUBRIKY)',
